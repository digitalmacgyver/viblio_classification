...
Currently, the libraries are the latest versions. In case they will be out of date, you can also find them on our website: http://lear.inrialpes.fr/people/wang/dense_trajectories
...
* May 2011: dense_trajectory_release.tar.gz

* September 2012: dense_trajectory_release_v1.1.tar.gz 
  With the latest libraries and bugs fixed, thanks Nguyen Chi Dat for bug reporting.
