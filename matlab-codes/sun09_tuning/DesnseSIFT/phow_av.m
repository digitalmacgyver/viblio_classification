function feat = phow_av(conf, im)
% PHOW  Extract PHOW features
%
%   Author:: Andrea Vedaldi
%   Modified slightly by Arash Vahdat
...
% changed by Arash to get floating point features.
% opts = {'windowsize', 1, 'verbose'} ;
opts = {'windowsize', 1, 'FloatDescriptors'} ;
...
% changed by Arash to get data in our format
