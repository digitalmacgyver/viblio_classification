...
#usage :  python video_classifier.py -v /home/rgolla/Desktop/vid4.mp4 -d /home/rgolla/Downloads/vid4 -config /home/rgolla/Desktop/classification/viblio/resources/ml/svm_config.cfg
...
if __name__ == '__main__':
    ...
    os.system('python viblio_classifier.py -d %s -i %s_features.txt -c %s -s predict'%(results.output_directory,path1,results.config_file))
