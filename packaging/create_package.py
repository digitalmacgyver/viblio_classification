...
filelist=['../viblio/__init__.py','../viblio/bin/expansion_library.so','../viblio/bin/hog2D_library.so','../viblio/common','../viblio/install','../viblio/projects','../viblio/resources/ml','../viblio/resources/features/feature.cfg','../viblio/resources/features/codebooks/centers_4000_hog2x2_patch=18_imageDim=640_whiten=1.mat','../viblio/src/expand_feature.o','../viblio/src/make.sh','../viblio/src/rawHOG2DFeatures.c','../viblio/src/rawHOG2DFeatures.o','../viblio/src/vl_feat/vlfeat-0.9.16/bin', '../install-deps.sh' ]
